...
SWIFT_CLASS("_TtC6Spring11AsyncButton")
...
SWIFT_CLASS("_TtC6Spring14AsyncImageView")
...
SWIFT_CLASS("_TtC6Spring11SoundPlayer")
@interface SoundPlayer : NSObject
- (void)playSound:(NSString * _Nonnull)soundFile;
...
SWIFT_CLASS("_TtC6Spring15SpringAnimation")
