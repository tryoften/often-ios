...
//  Often
//
//  Created by Luc Succes on 4/21/16.
...
public class StyleKit : NSObject {
    ...
    public class func drawGlobe(frame frame: CGRect = CGRect(x: 0, y: 0, width: 35, height: 35), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// icon
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, frame.minX + 17.72, frame.minY + 16.87)
        CGContextScaleCTM(context, scale, scale)



        //// Oval-75 Drawing
        let oval75Path = UIBezierPath(ovalInRect: CGRect(x: -12.28, y: -13.08, width: 24.85, height: 25.09))
        strokeColor3.setStroke()
        ...
        path81Path.moveToPoint(CGPoint(x: -0.03, y: -13.27))
        path81Path.addLineToPoint(CGPoint(x: -0.03, y: 13.27))
        ...
        path81CopyPath.moveToPoint(CGPoint(x: 6.47, y: -11.77))
        path81CopyPath.addLineToPoint(CGPoint(x: 6.47, y: 11.77))
        ...
        path81Copy2Path.moveToPoint(CGPoint(x: -6.53, y: -11.77))
        path81Copy2Path.addLineToPoint(CGPoint(x: -6.53, y: 11.77))
        ...
        //// Path-82 Drawing
        let path82Path = UIBezierPath()
        path82Path.moveToPoint(CGPoint(x: -12.61, y: -0.54))
        path82Path.addLineToPoint(CGPoint(x: 12.61, y: -0.54))
        path82Path.miterLimit = 4;
    ...
    public class func drawMenuButton(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5, selected: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// Variable Declarations
        let menuButtonStrokeColor = selected ? tealColor : noneColor

        //// icon
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, frame.minX + 0.51000 * frame.width, frame.minY + 0.49000 * frame.height)
        CGContextScaleCTM(context, scale, scale)
        ...
        let pathPath = UIBezierPath(ovalInRect: CGRect(x: -44, y: -44, width: 88, height: 88))
        fillColor10.setFill()
        pathPath.fill()
        menuButtonStrokeColor.setStroke()
    ...
    public class func drawQuoteButton(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// Icon
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, frame.minX + 0.49510 * frame.width, frame.minY + 0.50149 * frame.height)
        CGContextScaleCTM(context, scale, scale)



        //// Label Drawing
        let labelRect = CGRect(x: -14.92, y: -24, width: 13.52, height: 48)
        let labelStyle = NSMutableParagraphStyle()
        labelStyle.alignment = .Left

        let labelFontAttributes = [NSFontAttributeName: UIFont(name: "Montserrat-Light", size: 48)!, NSForegroundColorAttributeName: textForeground2, NSParagraphStyleAttributeName: labelStyle]

        "“".drawInRect(labelRect, withAttributes: labelFontAttributes)


        //// Label 2 Drawing
        let label2Rect = CGRect(x: -2.31, y: -13, width: 17.23, height: 25)
        let label2Style = NSMutableParagraphStyle()
        label2Style.alignment = .Left

        let label2FontAttributes = [NSFontAttributeName: UIFont(name: "Montserrat-Light", size: 24)!, NSForegroundColorAttributeName: textForeground2, NSParagraphStyleAttributeName: label2Style]

        "A".drawInRect(label2Rect, withAttributes: label2FontAttributes)
    ...
    public class func drawGifsButton(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5) {
        ...
        //// icon
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, frame.minX + 0.50769 * frame.width, frame.minY + 0.49500 * frame.height)
        CGContextScaleCTM(context, scale, scale)
    ...
    public class func drawBackspaceIcon(frame frame: CGRect = CGRect(x: 0, y: 0, width: 55, height: 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), emojiScale: CGFloat = 1) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.moveToPoint(CGPoint(x: 5.78, y: -7.95))
        bezierPath.addLineToPoint(CGPoint(x: -0, y: -2.12))
        bezierPath.addLineToPoint(CGPoint(x: -5.78, y: -7.95))
        bezierPath.addCurveToPoint(CGPoint(x: -7.89, y: -7.95), controlPoint1: CGPoint(x: -6.37, y: -8.54), controlPoint2: CGPoint(x: -7.31, y: -8.54))
        bezierPath.addCurveToPoint(CGPoint(x: -7.89, y: -5.83), controlPoint1: CGPoint(x: -8.48, y: -7.37), controlPoint2: CGPoint(x: -8.47, y: -6.42))
        bezierPath.addLineToPoint(CGPoint(x: -2.1, y: 0))
        bezierPath.addLineToPoint(CGPoint(x: -7.89, y: 5.83))
        bezierPath.addCurveToPoint(CGPoint(x: -7.89, y: 7.95), controlPoint1: CGPoint(x: -8.47, y: 6.42), controlPoint2: CGPoint(x: -8.47, y: 7.37))
        bezierPath.addCurveToPoint(CGPoint(x: -5.78, y: 7.95), controlPoint1: CGPoint(x: -7.31, y: 8.54), controlPoint2: CGPoint(x: -6.37, y: 8.54))
        bezierPath.addLineToPoint(CGPoint(x: -0, y: 2.12))
        bezierPath.addLineToPoint(CGPoint(x: 5.78, y: 7.95))
        bezierPath.addCurveToPoint(CGPoint(x: 7.89, y: 7.95), controlPoint1: CGPoint(x: 6.37, y: 8.54), controlPoint2: CGPoint(x: 7.31, y: 8.54))
        bezierPath.addCurveToPoint(CGPoint(x: 7.89, y: 5.83), controlPoint1: CGPoint(x: 8.48, y: 7.37), controlPoint2: CGPoint(x: 8.47, y: 6.42))
        ...
        bezierPath.addCurveToPoint(CGPoint(x: 5.78, y: -7.95), controlPoint1: CGPoint(x: 7.31, y: -8.54), controlPoint2: CGPoint(x: 6.37, y: -8.54))
        bezierPath.closePath()
        bezierPath.moveToPoint(CGPoint(x: 20.09, y: -11.01))
        bezierPath.addLineToPoint(CGPoint(x: 20.09, y: 10.73))
        bezierPath.addCurveToPoint(CGPoint(x: 13.09, y: 17.72), controlPoint1: CGPoint(x: 20.09, y: 14.59), controlPoint2: CGPoint(x: 16.97, y: 17.72))
        bezierPath.addLineToPoint(CGPoint(x: -8.91, y: 17.72))
        bezierPath.addCurveToPoint(CGPoint(x: -14.18, y: 15.76), controlPoint1: CGPoint(x: -10.56, y: 17.72), controlPoint2: CGPoint(x: -12.92, y: 16.85))
        bezierPath.addLineToPoint(CGPoint(x: -25.7, y: 5.87))
        bezierPath.addCurveToPoint(CGPoint(x: -25.94, y: -4.81), controlPoint1: CGPoint(x: -29.05, y: 3), controlPoint2: CGPoint(x: -29.15, y: -1.79))
        bezierPath.addLineToPoint(CGPoint(x: -14.09, y: -15.95))
        bezierPath.addCurveToPoint(CGPoint(x: -8.91, y: -18), controlPoint1: CGPoint(x: -12.88, y: -17.08), controlPoint2: CGPoint(x: -10.57, y: -18))
        bezierPath.addLineToPoint(CGPoint(x: 13.09, y: -18))
        bezierPath.addCurveToPoint(CGPoint(x: 20.09, y: -11.01), controlPoint1: CGPoint(x: 16.96, y: -18), controlPoint2: CGPoint(x: 20.09, y: -14.86))
        bezierPath.closePath()
    ...
    public class func imageOfGlobe(frame frame: CGRect = CGRect(x: 0, y: 0, width: 35, height: 35), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawGlobe(frame: CGRect(x: 0, y: 0, width: frame.size.width, height: frame.size.height), scale: scale)
    ...
    public class func imageOfMenuButton(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5, selected: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawMenuButton(frame: CGRect(x: 0, y: 0, width: frame.size.width, height: frame.size.height), scale: scale, selected: selected)
    ...
    public class func imageOfQuoteButton(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawQuoteButton(frame: CGRect(x: 0, y: 0, width: frame.size.width, height: frame.size.height), scale: scale)

        let imageOfQuoteButton = UIGraphicsGetImageFromCurrentImageContext()
        UIGraphicsEndImageContext()

        return imageOfQuoteButton
    }
    ...
    public class func imageOfBackspaceIcon(frame frame: CGRect = CGRect(x: 0, y: 0, width: 55, height: 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), emojiScale: CGFloat = 1) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawBackspaceIcon(frame: CGRect(x: 0, y: 0, width: frame.size.width, height: frame.size.height), color: color, emojiScale: emojiScale)
