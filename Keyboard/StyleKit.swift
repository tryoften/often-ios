...
public class StyleKit : NSObject {
    ...
    public class func drawRecentIcon(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), emojiScale: CGFloat = 1) {
        ...
        let oval99CopyPath = UIBezierPath(ovalInRect: CGRectMake(-15, -15, 30, 30))
        color.setStroke()
        ...
        let rectangle554Path = UIBezierPath(rect: CGRectMake(-1, -10, 2, 12))
        color.setFill()
        rectangle554Path.fill()


        //// Rectangle-555 Drawing
        let rectangle555Path = UIBezierPath(rect: CGRectMake(-8, 0, 9, 2))
        color.setFill()
    ...
    public class func drawPeopleCanvas(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), emojiScale: CGFloat = 1) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
    ...
    public class func drawFoodIcon(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), emojiScale: CGFloat = 1) {
        ...
        let fillColor14 = UIColor(red: 0.864, green: 0.864, blue: 0.864, alpha: 1.000)
        ...
        path95Path.moveToPoint(CGPointMake(-5.96, 13.21))
        ...
        oval110CopyPath.moveToPoint(CGPointMake(-6.27, 6.83))
        oval110CopyPath.addCurveToPoint(CGPointMake(2.94, 6.83), controlPoint1: CGPointMake(-4.69, 5.78), controlPoint2: CGPointMake(-0.99, 6.83))
        oval110CopyPath.addLineToPoint(CGPointMake(13.49, 6.83))
        ...
        oval110CopyPath.closePath()
        oval110CopyPath.miterLimit = 4;

        oval110CopyPath.usesEvenOddFillRule = true;

        fillColor10.setFill()
        oval110CopyPath.fill()
        color.setStroke()
        oval110CopyPath.lineWidth = 2
        oval110CopyPath.stroke()


        //// Rectangle-559 Drawing
        let rectangle559Path = UIBezierPath(roundedRect: CGRectMake(-9.1, 3.23, 25.19, 5.24), cornerRadius: 2.62)
        color.setFill()
        rectangle559Path.fill()
        color.setStroke()
        rectangle559Path.lineWidth = 1
        rectangle559Path.stroke()


        //// Path-96 Drawing
        let path96Path = UIBezierPath()
        path96Path.moveToPoint(CGPointMake(-6.74, 4.33))
        path96Path.addLineToPoint(CGPointMake(3.73, 7.83))
        path96Path.addLineToPoint(CGPointMake(13.63, 4.33))
        path96Path.addLineToPoint(CGPointMake(-6.74, 4.33))
        path96Path.closePath()
        path96Path.miterLimit = 4;

        path96Path.usesEvenOddFillRule = true;

        fillColor14.setFill()
        path96Path.fill()
        color.setStroke()
        path96Path.lineWidth = 1
        path96Path.stroke()
    ...
    public class func drawConfettiIcon(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), emojiScale: CGFloat = 1) {
        ...
        path103Path.moveToPoint(CGPointMake(-11.88, 14.53))
        ...
        path103Path.addLineToPoint(CGPointMake(5.76, 6.21))
    ...
    public class func drawPersonIcon(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), emojiScale: CGFloat = 1) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
    ...
    public class func drawBuildingsIcon(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), emojiScale: CGFloat = 1) {
        ...
        //// Color Declarations
        let fillColor10 = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)
        let fillColor15 = UIColor(red: 0.812, green: 0.812, blue: 0.812, alpha: 1.000)
        ...
        let rectangle600Path = UIBezierPath(roundedRect: CGRectMake(-7.47, -2.29, 15, 11), cornerRadius: 5.5)
        color.setStroke()
        ...
        let rectangle597Path = UIBezierPath(roundedRect: CGRectMake(-8.47, 11.71, 4, 4), cornerRadius: 1)
        color.setFill()
        ...
        let rectangle597CopyPath = UIBezierPath(roundedRect: CGRectMake(4.53, 11.71, 4, 4), cornerRadius: 1)
        color.setFill()
    ...
    public class func imageOfPeopleCanvas(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), emojiScale: CGFloat = 1) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawPeopleCanvas(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color, emojiScale: emojiScale)

        let imageOfPeopleCanvas = UIGraphicsGetImageFromCurrentImageContext()
        UIGraphicsEndImageContext()

        return imageOfPeopleCanvas
    }
    ...
    public class func imageOfPersonIcon(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), emojiScale: CGFloat = 1) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawPersonIcon(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color, emojiScale: emojiScale)

        let imageOfPersonIcon = UIGraphicsGetImageFromCurrentImageContext()
        UIGraphicsEndImageContext()

        return imageOfPersonIcon
    }
