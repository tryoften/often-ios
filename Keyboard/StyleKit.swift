...
//  Often
//
//  Created by Luc Succes on 4/26/16.
...
public class StyleKit : NSObject {
    ...
    public class func drawGlobe(frame frame: CGRect = CGRect(x: 0, y: 0, width: 35, height: 35), scale: CGFloat = 0.5) {
        ...
        //// icon
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, frame.minX + 17.79, frame.minY + 16.6)
        CGContextScaleCTM(context, scale, scale)
        ...
        path81Path.addLineToPoint(CGPoint(x: -0.17, y: 13.8))
        ...
        path81CopyPath.addLineToPoint(CGPoint(x: 6.33, y: 12.3))
        ...
        path81Copy2Path.moveToPoint(CGPoint(x: -6.67, y: -11.23))
        path81Copy2Path.addLineToPoint(CGPoint(x: -6.67, y: 12.3))
    ...
    public class func drawCategoriesMenuButton(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5, selected: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        let pathPath = UIBezierPath(ovalInRect: CGRect(x: -40, y: -40, width: 80, height: 80))
        fillColor10.setFill()
        pathPath.fill()
        menuButtonSelected.setStroke()
        pathPath.lineWidth = 8
        pathPath.stroke()
    ...
    public class func drawPacksMenuButton(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5, selected: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
    ...
    public class func drawQuotesMenuButton(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5, selected: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
    ...
    public class func drawGifMenuButton(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5, selected: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// Rectangle-614 Drawing
        let rectangle614Path = UIBezierPath(rect: CGRect(x: 7, y: -17, width: 6, height: 4))
        fillColor3.setFill()
        rectangle614Path.fill()
    ...
    public class func imageOfCategoriesMenuButton(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5, selected: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawCategoriesMenuButton(frame: CGRect(x: 0, y: 0, width: frame.size.width, height: frame.size.height), scale: scale, selected: selected)
    ...
    public class func imageOfPacksMenuButton(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5, selected: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawPacksMenuButton(frame: CGRect(x: 0, y: 0, width: frame.size.width, height: frame.size.height), scale: scale, selected: selected)
    ...
    public class func imageOfQuotesMenuButton(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5, selected: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawQuotesMenuButton(frame: CGRect(x: 0, y: 0, width: frame.size.width, height: frame.size.height), scale: scale, selected: selected)
    ...
    public class func imageOfGifMenuButton(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5, selected: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawGifMenuButton(frame: CGRect(x: 0, y: 0, width: frame.size.width, height: frame.size.height), scale: scale, selected: selected)
