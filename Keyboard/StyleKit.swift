...
//  Often
//
//  Created by Luc Succes on 4/1/16.
...
public class StyleKit : NSObject {
    ...
    public class func drawGlobe(frame frame: CGRect = CGRect(x: 0, y: 0, width: 35, height: 35), scale: CGFloat = 0.5) {
        ...
        //// Oval-75 Drawing
        let oval75Path = UIBezierPath(ovalInRect: CGRect(x: 0.33, y: 0.19, width: 24.85, height: 25.09))
        strokeColor3.setStroke()
        ...
        path81Path.moveToPoint(CGPoint(x: 12.59, y: 0))
        path81Path.addLineToPoint(CGPoint(x: 12.59, y: 26.53))
        ...
        path81CopyPath.moveToPoint(CGPoint(x: 19.09, y: 1.5))
        path81CopyPath.addLineToPoint(CGPoint(x: 19.09, y: 25.04))
        ...
        path81Copy2Path.moveToPoint(CGPoint(x: 6.09, y: 1.5))
        path81Copy2Path.addLineToPoint(CGPoint(x: 6.09, y: 25.04))
        ...
        //// Path-82 Drawing
        let path82Path = UIBezierPath()
        path82Path.moveToPoint(CGPoint(x: 0, y: 12.73))
        path82Path.addLineToPoint(CGPoint(x: 25.23, y: 12.73))
        path82Path.miterLimit = 4;
    ...
    public class func drawEnterkey(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5) {
        ...
        //// enter
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, frame.minX + 16.7, frame.minY + 18.98)
        CGContextScaleCTM(context, scale, scale)
        ...
        //// Path-82 Drawing
        let path82Path = UIBezierPath()
        path82Path.moveToPoint(CGPoint(x: 4.23, y: 12.02))
        path82Path.addLineToPoint(CGPoint(x: 28.44, y: 12.02))
        path82Path.addCurveToPoint(CGPoint(x: 32.43, y: 8.01), controlPoint1: CGPoint(x: 30.64, y: 12.02), controlPoint2: CGPoint(x: 32.43, y: 10.23))
        path82Path.addLineToPoint(CGPoint(x: 32.43, y: 2.14))
        path82Path.miterLimit = 4;
        ...
        path83Path.moveToPoint(CGPoint(x: 13, y: 0))
        path83Path.addLineToPoint(CGPoint(x: 0.31, y: 11.37))
        path83Path.addCurveToPoint(CGPoint(x: 0.31, y: 12.7), controlPoint1: CGPoint(x: -0.1, y: 11.74), controlPoint2: CGPoint(x: -0.1, y: 12.33))
        path83Path.addLineToPoint(CGPoint(x: 13, y: 24))
