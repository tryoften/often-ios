...
public class StyleKit : NSObject {
    ...
    public class func drawCancel(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
    ...
    public class func drawRefresharrow(frame frame: CGRect = CGRectMake(4, 2, 22, 26), scale: CGFloat = 0.5) {
        ...
        //// arrow
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, frame.minX + 0.50000 * frame.width, frame.minY + 0.55769 * frame.height)
        CGContextScaleCTM(context, scale, scale)
    ...
    public class func imageOfCancel(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
