...
//  Often
//
//  Created by Luc Succes on 1/19/16.
...
public class StyleKit : NSObject {
    ...
    public class func drawSharebutton(frame frame: CGRect = CGRectMake(0, 0, 35, 35), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
    ...
    public class func drawToggle(scale scale: CGFloat = 0.5, toggleOn: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        let noneColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 0.000)
        let tealColor = UIColor(red: 0.145, green: 0.780, blue: 0.530, alpha: 1.000)
        let toggleBaseColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)
        let strokeColor6 = UIColor(red: 0.145, green: 0.780, blue: 0.530, alpha: 1.000)
        let toogleHighlightedTextForeground = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)
        let toogleTextForeground = UIColor(red: 0.067, green: 0.093, blue: 0.160, alpha: 1.000)

        //// Variable Declarations
        let toggleOnTextForeground = toggleOn ? toogleHighlightedTextForeground : toogleTextForeground
        let toggleOnFillColor = toggleOn ? tealColor : toggleBaseColor
        let toggleOffTextForeground = toggleOn ? toogleTextForeground : toogleHighlightedTextForeground
        let toggleOffFillColor = toggleOn ? noneColor : tealColor
        ...
        //// Rectangle-692 Drawing
        let rectangle692Path = UIBezierPath(rect: CGRectMake(frame.minX, frame.minY, 174, 58))
        toggleOffFillColor.setFill()
        rectangle692Path.fill()
        strokeColor6.setStroke()
        rectangle692Path.lineWidth = 2
        rectangle692Path.stroke()


        //// Rectangle-692-Copy Drawing
        let rectangle692CopyPath = UIBezierPath(rect: CGRectMake(frame.minX, frame.minY + 0.08, 88.5, 58))
        toggleOnFillColor.setFill()
        rectangle692CopyPath.fill()
        strokeColor6.setStroke()
        rectangle692CopyPath.lineWidth = 2
        rectangle692CopyPath.stroke()


        //// Label Drawing
        let labelRect = CGRectMake(frame.minX + 31, frame.minY + 11, 26.74, 30)
        let labelStyle = NSParagraphStyle.defaultParagraphStyle().mutableCopy() as! NSMutableParagraphStyle
        labelStyle.alignment = .Left

        let labelFontAttributes = [NSFontAttributeName: UIFont(name: "OpenSans-Light", size: 18)!, NSForegroundColorAttributeName: toggleOnTextForeground, NSParagraphStyleAttributeName: labelStyle]

        "ON".drawInRect(labelRect, withAttributes: labelFontAttributes)


        //// Label 2 Drawing
        let label2Rect = CGRectMake(115, 11, 35, 30)
        let label2Style = NSParagraphStyle.defaultParagraphStyle().mutableCopy() as! NSMutableParagraphStyle
        label2Style.alignment = .Left

        let label2FontAttributes = [NSFontAttributeName: UIFont(name: "OpenSans-Light", size: 18)!, NSForegroundColorAttributeName: toggleOffTextForeground, NSParagraphStyleAttributeName: label2Style]
    ...
    public class func imageOfSharebutton(frame frame: CGRect = CGRectMake(0, 0, 35, 35), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawSharebutton(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), scale: scale)
    ...
    public class func imageOfToggle(scale scale: CGFloat = 0.5, toggleOn: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSizeMake(87, 29), false, 0)
            StyleKit.drawToggle(scale: scale, toggleOn: toggleOn)

        let imageOfToggle = UIGraphicsGetImageFromCurrentImageContext()
        UIGraphicsEndImageContext()

        return imageOfToggle
    }
