...
//  Often
//
//  Created by Luc Succes on 8/11/16.
...
public class StyleKit : NSObject {
    ...
    public class func drawBackspace(frame2 frame2: CGRect = CGRectMake(-15, -6, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), keySize: CGRect = CGRectMake(0, 0, 35, 35)) {
    ...
    public class func drawSearchbaricon(frame frame: CGRect = CGRectMake(0, 0, 35, 35), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5) {
        ...
        //// Path-82 Drawing
        let path82Path = UIBezierPath()
        path82Path.moveToPoint(CGPointMake(8.04, 9.66))
        path82Path.addLineToPoint(CGPointMake(14.24, 16.32))
        path82Path.miterLimit = 4;
        ...
        //// Oval-77 Drawing
        let oval77Path = UIBezierPath(ovalInRect: CGRectMake(-11.5, -9, 24, 20))
        color.setStroke()
        oval77Path.lineWidth = 3
        oval77Path.stroke()
    ...
    public class func drawPremium(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        star1Path.moveToPoint(CGPointMake(0, -17))
        star1Path.addLineToPoint(CGPointMake(3.89, -11.98))
        star1Path.addLineToPoint(CGPointMake(9.99, -13.75))
        star1Path.addLineToPoint(CGPointMake(10.19, -7.41))
        star1Path.addLineToPoint(CGPointMake(16.17, -5.25))
        star1Path.addLineToPoint(CGPointMake(12.6, 0))
        star1Path.addLineToPoint(CGPointMake(16.17, 5.25))
        star1Path.addLineToPoint(CGPointMake(10.19, 7.41))
        star1Path.addLineToPoint(CGPointMake(9.99, 13.75))
        star1Path.addLineToPoint(CGPointMake(3.89, 11.98))
        star1Path.addLineToPoint(CGPointMake(0, 17))
        star1Path.addLineToPoint(CGPointMake(-3.89, 11.98))
        star1Path.addLineToPoint(CGPointMake(-9.99, 13.75))
        star1Path.addLineToPoint(CGPointMake(-10.19, 7.41))
        star1Path.addLineToPoint(CGPointMake(-16.17, 5.25))
        ...
        //// Path-106 Drawing
        let path106Path = UIBezierPath()
        path106Path.moveToPoint(CGPointMake(-5.95, 0.79))
        path106Path.addLineToPoint(CGPointMake(-2.1, 4.23))
        path106Path.addLineToPoint(CGPointMake(5.95, -4.23))
        path106Path.miterLimit = 4;
    ...
    public class func drawCategoryicon(frame frame: CGRect = CGRectMake(0, 0, 35, 35), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        let rectangle816Copy4Path = UIBezierPath(rect: CGRectMake(24, 24, 10, 10))
        selectedGrayFillColor.setFill()
        rectangle816Copy4Path.fill()


        //// Rectangle-816-Copy-9 Drawing
        let rectangle816Copy9Path = UIBezierPath(rect: CGRectMake(24, 37, 10, 10))
        selectedGrayFillColor.setFill()
        rectangle816Copy9Path.fill()


        //// Rectangle-816-Copy-5 Drawing
        let rectangle816Copy5Path = UIBezierPath(rect: CGRectMake(37, 24, 10, 10))
        selectedGrayFillColor.setFill()
        rectangle816Copy5Path.fill()


        //// Rectangle-816-Copy-10 Drawing
        let rectangle816Copy10Path = UIBezierPath(rect: CGRectMake(37, 37, 10, 10))
        selectedGrayFillColor.setFill()
    ...
    public class func drawGlobe(frame frame: CGRect = CGRectMake(0, 0, 35, 35), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// Oval-75 Drawing
        let oval75Path = UIBezierPath(ovalInRect: CGRectMake(-12.43, -12.55, 24.85, 25.09))
        strokeColor.setStroke()
        ...
        path81Path.moveToPoint(CGPointMake(-0.17, -12.73))
        path81Path.addLineToPoint(CGPointMake(-0.17, 9.23))
        path81Path.addLineToPoint(CGPointMake(-0.17, 12.8))
        ...
        path81CopyPath.moveToPoint(CGPointMake(6.33, -11.23))
        path81CopyPath.addLineToPoint(CGPointMake(6.42, 10.8))
        ...
        path81Copy2Path.moveToPoint(CGPointMake(-6.67, -11.2))
        path81Copy2Path.addLineToPoint(CGPointMake(-6.67, -5.12))
        path81Copy2Path.addLineToPoint(CGPointMake(-6.67, 10.8))
        ...
        //// Path-82 Drawing
        let path82Path = UIBezierPath()
        path82Path.moveToPoint(CGPointMake(-12.76, -0))
        path82Path.addLineToPoint(CGPointMake(12.47, -0))
        path82Path.miterLimit = 4;
    ...
    public class func drawPacktab(frame frame: CGRect = CGRectMake(19, 11, 50, 50), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        let rectangle758Path = UIBezierPath(rect: CGRectMake(8, 0, 5, 23.62))
        fillColor3.setFill()
        rectangle758Path.fill()


        //// Rectangle-758-Copy-4 Drawing
        let rectangle758Copy4Path = UIBezierPath(rect: CGRectMake(0, 0, 5, 23.62))
        fillColor3.setFill()
        rectangle758Copy4Path.fill()


        //// Rectangle-758-Copy Drawing
        let rectangle758CopyPath = UIBezierPath(rect: CGRectMake(16, 0, 5, 23.62))
        fillColor3.setFill()
        rectangle758CopyPath.fill()


        //// Rectangle-758-Copy-2 Drawing
        let rectangle758Copy2Path = UIBezierPath(rect: CGRectMake(24, 0, 5, 23.62))
        fillColor3.setFill()
    ...
    public class func drawEnterkey(frame frame: CGRect = CGRectMake(0, 0, 50, 50), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
    ...
    public class func drawCheckicon(color color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) {
        ...
        //// Frames
        let frame = CGRectMake(-35, -35, 70, 70)
        ...
        let checkPath = UIBezierPath()
        checkPath.moveToPoint(CGPointMake(-17.5, 1))
        checkPath.addLineToPoint(CGPointMake(-5.5, 13))
        checkPath.addLineToPoint(CGPointMake(17.5, -13))
        checkPath.miterLimit = 4;
    ...
    public class func drawClipboard_button(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        let path926Path = UIBezierPath()
        path926Path.moveToPoint(CGPointMake(10.24, 3.41))
        path926Path.addLineToPoint(CGPointMake(10.24, -12.8))
        path926Path.addCurveToPoint(CGPointMake(0.21, -22.19), controlPoint1: CGPointMake(10.24, -12.8), controlPoint2: CGPointMake(11.09, -22.19))
        path926Path.addCurveToPoint(CGPointMake(-10.25, -12.8), controlPoint1: CGPointMake(-10.68, -22.19), controlPoint2: CGPointMake(-10.25, -12.8))
        path926Path.addLineToPoint(CGPointMake(-10.25, 15.36))
        path926Path.addCurveToPoint(CGPointMake(-3.42, 22.19), controlPoint1: CGPointMake(-10.25, 15.36), controlPoint2: CGPointMake(-10.39, 22.19))
        path926Path.addCurveToPoint(CGPointMake(3.69, 15.36), controlPoint1: CGPointMake(3.55, 22.19), controlPoint2: CGPointMake(3.69, 15.36))
        path926Path.addLineToPoint(CGPointMake(3.69, -9.39))
        path926Path.addCurveToPoint(CGPointMake(0.21, -13.66), controlPoint1: CGPointMake(3.69, -9.39), controlPoint2: CGPointMake(4.26, -13.66))
        path926Path.addCurveToPoint(CGPointMake(-3.42, -9.39), controlPoint1: CGPointMake(-3.85, -13.66), controlPoint2: CGPointMake(-3.42, -9.39))
        path926Path.addLineToPoint(CGPointMake(-3.42, 13.66))
        path926Path.miterLimit = 4;
    ...
    public class func drawThumbslider(frame frame: CGRect = CGRectMake(0, 0, 51, 50), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        shadow.shadowOffset = CGSizeMake(0.1, 4.1)
        ...
        //// path- Drawing
        let pathPath = UIBezierPath(roundedRect: CGRectMake(6, 0, 92, 24), cornerRadius: 12)
        CGContextSaveGState(context)
    ...
    public class func drawSlider(frame frame: CGRect = CGRectMake(0, 0, 568, 39), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        let rectangle401Path = UIBezierPath(roundedRect: CGRectMake(0, 0, 1136, 14), cornerRadius: 7)
        fillColor18.setFill()
    ...
    public class func drawCategoryButton(frame frame: CGRect = CGRectMake(0, 0, 50, 50), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// Rectangle-816-Copy-4 Drawing
        let rectangle816Copy4Path = UIBezierPath(rect: CGRectMake(-19, -12, 10, 10))
        fillColor3.setFill()
        rectangle816Copy4Path.fill()


        //// Rectangle-816-Copy-9 Drawing
        let rectangle816Copy9Path = UIBezierPath(rect: CGRectMake(-19, 2, 10, 10))
        fillColor3.setFill()
        rectangle816Copy9Path.fill()


        //// Rectangle-816-Copy-5 Drawing
        let rectangle816Copy5Path = UIBezierPath(rect: CGRectMake(-5, -12, 10, 10))
        fillColor3.setFill()
        rectangle816Copy5Path.fill()


        //// Rectangle-816-Copy-10 Drawing
        let rectangle816Copy10Path = UIBezierPath(rect: CGRectMake(-5, 2, 10, 10))
        fillColor3.setFill()
        rectangle816Copy10Path.fill()


        //// Rectangle-816-Copy-6 Drawing
        let rectangle816Copy6Path = UIBezierPath(rect: CGRectMake(9, -12, 10, 10))
        fillColor3.setFill()
        rectangle816Copy6Path.fill()


        //// Rectangle-816-Copy-11 Drawing
        let rectangle816Copy11Path = UIBezierPath(rect: CGRectMake(9, 2, 10, 10))
        fillColor3.setFill()
    ...
    public class func drawGifsButton(frame frame: CGRect = CGRectMake(0, 0, 50, 50), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// Label Drawing
        let labelRect = CGRectMake(-24.97, -14, 49.94, 28)
    ...
    public class func drawQuotesButton(frame frame: CGRect = CGRectMake(0, 0, 50, 50), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// Label Drawing
        let labelRect = CGRectMake(-8.81, -13.5, 17.23, 36)
        let labelStyle = NSParagraphStyle.defaultParagraphStyle().mutableCopy() as! NSMutableParagraphStyle
        labelStyle.alignment = .Left
        ...
        //// Label 2 Drawing
        let label2Rect = CGRectMake(-20.82, -34.5, 19.92, 69)
    ...
    public class func drawMenuButton(frame frame: CGRect = CGRectMake(1, 0, 50, 50), selected: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// path- Drawing
        let pathPath = UIBezierPath(ovalInRect: CGRectMake(-47, -47, 94, 94))
        fillColor10.setFill()
        pathPath.fill()
    ...
    public class func drawCategoriesMenuButton(frame frame: CGRect = CGRectMake(0, 0, 50, 50), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        path594Path.moveToPoint(CGPointMake(-9, 5))
        path594Path.addCurveToPoint(CGPointMake(0, 10), controlPoint1: CGPointMake(-9, 5), controlPoint2: CGPointMake(-6.65, 10))
        path594Path.addCurveToPoint(CGPointMake(9, 5), controlPoint1: CGPointMake(6.65, 10), controlPoint2: CGPointMake(9, 5))
        ...
        //// Oval-370 Drawing
        let oval370Path = UIBezierPath(ovalInRect: CGRectMake(-10, -10, 6, 6))
        fillColor3.setFill()
        oval370Path.fill()


        //// Oval-370-Copy Drawing
        let oval370CopyPath = UIBezierPath(ovalInRect: CGRectMake(4, -10, 6, 6))
        fillColor3.setFill()
    ...
    public class func drawQuotesMenuButton(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        combinedShapePath.moveToPoint(CGPointMake(-6.19, -1.13))
        combinedShapePath.addCurveToPoint(CGPointMake(-3.47, 3.32), controlPoint1: CGPointMake(-4.57, -0.31), controlPoint2: CGPointMake(-3.47, 1.38))
        combinedShapePath.addCurveToPoint(CGPointMake(-8.47, 8.32), controlPoint1: CGPointMake(-3.47, 6.08), controlPoint2: CGPointMake(-5.71, 8.32))
        combinedShapePath.addCurveToPoint(CGPointMake(-13.47, 3.32), controlPoint1: CGPointMake(-11.23, 8.32), controlPoint2: CGPointMake(-13.47, 6.08))
        combinedShapePath.addCurveToPoint(CGPointMake(-12.67, 0.61), controlPoint1: CGPointMake(-13.47, 2.32), controlPoint2: CGPointMake(-13.17, 1.39))
        combinedShapePath.addCurveToPoint(CGPointMake(-12.56, 0.35), controlPoint1: CGPointMake(-12.65, 0.53), controlPoint2: CGPointMake(-12.61, 0.44))
        combinedShapePath.addLineToPoint(CGPointMake(-6.88, -9.08))
        combinedShapePath.addLineToPoint(CGPointMake(-2.42, -9.08))
        combinedShapePath.addLineToPoint(CGPointMake(-6.19, -1.13))
        ...
        combinedShapeCopyPath.moveToPoint(CGPointMake(8.81, -1.13))
        combinedShapeCopyPath.addCurveToPoint(CGPointMake(11.53, 3.32), controlPoint1: CGPointMake(10.43, -0.31), controlPoint2: CGPointMake(11.53, 1.38))
        combinedShapeCopyPath.addCurveToPoint(CGPointMake(6.53, 8.32), controlPoint1: CGPointMake(11.53, 6.08), controlPoint2: CGPointMake(9.29, 8.32))
        combinedShapeCopyPath.addCurveToPoint(CGPointMake(1.53, 3.32), controlPoint1: CGPointMake(3.77, 8.32), controlPoint2: CGPointMake(1.53, 6.08))
        combinedShapeCopyPath.addCurveToPoint(CGPointMake(2.33, 0.61), controlPoint1: CGPointMake(1.53, 2.32), controlPoint2: CGPointMake(1.83, 1.39))
        combinedShapeCopyPath.addCurveToPoint(CGPointMake(2.44, 0.35), controlPoint1: CGPointMake(2.35, 0.53), controlPoint2: CGPointMake(2.39, 0.44))
        combinedShapeCopyPath.addLineToPoint(CGPointMake(8.12, -9.08))
        combinedShapeCopyPath.addLineToPoint(CGPointMake(12.58, -9.08))
        combinedShapeCopyPath.addLineToPoint(CGPointMake(8.81, -1.13))
    ...
    public class func drawHashtagicon(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        path218Path.moveToPoint(CGPointMake(-7.75, 11.61))
        path218Path.addLineToPoint(CGPointMake(-3.02, -11.61))
        path218Path.addLineToPoint(CGPointMake(-7.75, 11.61))
        ...
        path218CopyPath.moveToPoint(CGPointMake(3.28, 11.61))
        path218CopyPath.addLineToPoint(CGPointMake(8.01, -11.61))
        path218CopyPath.addLineToPoint(CGPointMake(3.28, 11.61))
        ...
        path220Path.moveToPoint(CGPointMake(-11.03, -4.25))
        path220Path.addLineToPoint(CGPointMake(12.61, -4.25))
        path220Path.addLineToPoint(CGPointMake(-11.03, -4.25))
        ...
        path220CopyPath.moveToPoint(CGPointMake(-12.61, 4.27))
        path220CopyPath.addLineToPoint(CGPointMake(11.03, 4.27))
        path220CopyPath.addLineToPoint(CGPointMake(-12.61, 4.27))
    ...
    public class func drawShareButtonCanvas(frame frame: CGRect = CGRectMake(0, 0, 50, 50), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        let rectangle660Path = UIBezierPath(roundedRect: CGRectMake(-1.61, -14.23, 3.32, 15.31), cornerRadius: 1.66)
        ...
        let rectangle660CopyPath = UIBezierPath(rect: CGRectMake(-1.65, -7.1, 3.3, 14.2))
        mainAppHighlightColor.setFill()
        ...
        let rectangle660Copy2Path = UIBezierPath(rect: CGRectMake(-1.65, -7.1, 3.3, 14.2))
        mainAppHighlightColor.setFill()
        ...
        //// path-2 Drawing
        let path2Path = UIBezierPath(roundedRect: CGRectMake(-9.34, -1.1, 18.79, 18.59), cornerRadius: 3.3)
        mainAppHighlightColor.setStroke()
        path2Path.lineWidth = 4
        path2Path.stroke()
    ...
    public class func drawShareCanvas(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// path-2 Drawing
        let path2Path = UIBezierPath(roundedRect: CGRectMake(-9.34, 0.9, 18.79, 18.59), cornerRadius: 3.3)
        strokeColor.setStroke()
        path2Path.lineWidth = 4
        path2Path.stroke()
    ...
    public class func drawMainAppMenu(frame frame: CGRect = CGRectMake(0, 0, 35, 35), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        let rectangle477CopyPath = UIBezierPath(roundedRect: CGRectMake(0, 0, 30, 4), cornerRadius: 2)
        color.setFill()
        rectangle477CopyPath.fill()


        //// Rectangle-477-Copy-2 Drawing
        let rectangle477Copy2Path = UIBezierPath(roundedRect: CGRectMake(0, 12, 30, 4), cornerRadius: 2)
        color.setFill()
    ...
    public class func drawPackMenuButton(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000)) {

        //// icon
        //// Rectangle-758 Drawing
        let rectangle758Path = UIBezierPath(roundedRect: CGRectMake(frame.minX + 19, frame.minY + 23.62, 13, 2), cornerRadius: 1)
        color.setFill()
        rectangle758Path.fill()


        //// Rectangle-758-Copy-4 Drawing
        let rectangle758Copy4Path = UIBezierPath(roundedRect: CGRectMake(frame.minX + 19, frame.minY + 19.25, 13, 2), cornerRadius: 1)
        color.setFill()
        rectangle758Copy4Path.fill()


        //// Rectangle-758-Copy Drawing
        let rectangle758CopyPath = UIBezierPath(roundedRect: CGRectMake(frame.minX + 19, frame.minY + 28, 13, 2), cornerRadius: 1)
        color.setFill()
        rectangle758CopyPath.fill()
    }

    public class func drawGifMenuButton(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()

        //// icon
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, frame.minX + 0.51000 * frame.width, frame.minY + 0.50000 * frame.height)
        CGContextScaleCTM(context, (scale + 0.5), (scale + 0.5))



        //// path-1 Drawing
        let path1Path = UIBezierPath(roundedRect: CGRectMake(-7.5, -6, 15, 12), cornerRadius: 3)
        color.setStroke()
        ...
        triangle1Path.moveToPoint(CGPointMake(2.64, -0.76))
        triangle1Path.addCurveToPoint(CGPointMake(2.64, 0.36), controlPoint1: CGPointMake(3.13, -0.46), controlPoint2: CGPointMake(3.14, 0.04))
        triangle1Path.addLineToPoint(CGPointMake(-1.03, 2.63))
        triangle1Path.addCurveToPoint(CGPointMake(-1.93, 2.14), controlPoint1: CGPointMake(-1.53, 2.94), controlPoint2: CGPointMake(-1.93, 2.72))
        triangle1Path.addLineToPoint(CGPointMake(-1.93, -2.55))
        triangle1Path.addCurveToPoint(CGPointMake(-1.03, -3.04), controlPoint1: CGPointMake(-1.93, -3.13), controlPoint2: CGPointMake(-1.53, -3.35))
        triangle1Path.addLineToPoint(CGPointMake(2.64, -0.76))
    ...
    public class func drawCamera(scale scale: CGFloat = 0.5) {
        ...
        //// square Drawing
        let squarePath = UIBezierPath(roundedRect: CGRectMake(0, 7.6, 56, 40.4), cornerRadius: 3.73)
        fillColor20.setFill()
        squarePath.fill()


        //// Rectangle-27 Drawing
        let rectangle27Path = UIBezierPath(roundedRect: CGRectMake(6.4, -0, 13.07, 5.65), cornerRadius: 1.87)
        fillColor20.setFill()
        rectangle27Path.fill()


        //// Rectangle-88 Drawing
        let rectangle88Path = UIBezierPath(roundedRect: CGRectMake(42.93, 13.18, 7.47, 6.59), cornerRadius: 1.87)
        fillColor21.setFill()
        rectangle88Path.fill()


        //// Oval-6 Drawing
        let oval6Path = UIBezierPath(ovalInRect: CGRectMake(17.73, 18.06, 20.53, 20.71))
        fillColor21.setFill()
        oval6Path.fill()
    ...
    public class func drawDisclosureIndicatorCanvas(frame frame: CGRect = CGRectMake(0, 0, 35, 35), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000)) {

        //// disclosureIndicator Drawing
        let disclosureIndicatorPath = UIBezierPath()
        disclosureIndicatorPath.moveToPoint(CGPointMake(frame.minX + 12, frame.minY + 28.6))
        disclosureIndicatorPath.addLineToPoint(CGPointMake(frame.minX + 24, frame.minY + 17.8))
        disclosureIndicatorPath.addLineToPoint(CGPointMake(frame.minX + 12, frame.minY + 7))
    ...
    public class func drawPluscopy(frame frame: CGRect = CGRectMake(0, 0, 72, 72), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        iconPath.moveToPoint(CGPointMake(0.15, -15.2))
        iconPath.addLineToPoint(CGPointMake(-0.05, -15.2))
        iconPath.addCurveToPoint(CGPointMake(-0.3, -15.18), controlPoint1: CGPointMake(-0.13, -15.2), controlPoint2: CGPointMake(-0.22, -15.19))
        iconPath.addCurveToPoint(CGPointMake(-1.82, -13.9), controlPoint1: CGPointMake(-0.98, -15.09), controlPoint2: CGPointMake(-1.56, -14.62))
        iconPath.addCurveToPoint(CGPointMake(-1.95, -2), controlPoint1: CGPointMake(-1.92, -13.59), controlPoint2: CGPointMake(-1.94, -13.26))
        iconPath.addLineToPoint(CGPointMake(-11.98, -2))
        iconPath.addCurveToPoint(CGPointMake(-13.77, -1.85), controlPoint1: CGPointMake(-12.86, -2), controlPoint2: CGPointMake(-13.3, -2))
        iconPath.addCurveToPoint(CGPointMake(-15, 0.1), controlPoint1: CGPointMake(-14.51, -1.58), controlPoint2: CGPointMake(-15, -0.88))
        iconPath.addCurveToPoint(CGPointMake(-13.7, 1.87), controlPoint1: CGPointMake(-15, 0.88), controlPoint2: CGPointMake(-14.51, 1.58))
        iconPath.addCurveToPoint(CGPointMake(-1.95, 2), controlPoint1: CGPointMake(-13.4, 1.97), controlPoint2: CGPointMake(-13.07, 1.99))
        iconPath.addCurveToPoint(CGPointMake(-1.95, 11.78), controlPoint1: CGPointMake(-1.95, 4.74), controlPoint2: CGPointMake(-1.95, 7.96))
        iconPath.addCurveToPoint(CGPointMake(-1.8, 13.57), controlPoint1: CGPointMake(-1.95, 12.66), controlPoint2: CGPointMake(-1.95, 13.1))
        iconPath.addCurveToPoint(CGPointMake(-0.05, 14.8), controlPoint1: CGPointMake(-1.53, 14.31), controlPoint2: CGPointMake(-0.83, 14.8))
        iconPath.addLineToPoint(CGPointMake(0.15, 14.8))
        iconPath.addCurveToPoint(CGPointMake(1.92, 13.5), controlPoint1: CGPointMake(0.93, 14.8), controlPoint2: CGPointMake(1.63, 14.31))
        iconPath.addCurveToPoint(CGPointMake(2.05, 11.74), controlPoint1: CGPointMake(2.05, 13.1), controlPoint2: CGPointMake(2.05, 12.66))
        iconPath.addCurveToPoint(CGPointMake(2.05, 2), controlPoint1: CGPointMake(2.05, 11.74), controlPoint2: CGPointMake(2.05, 7.16))
        iconPath.addCurveToPoint(CGPointMake(11.98, 2), controlPoint1: CGPointMake(4.82, 2), controlPoint2: CGPointMake(8.09, 2))
        iconPath.addCurveToPoint(CGPointMake(13.77, 1.85), controlPoint1: CGPointMake(12.86, 2), controlPoint2: CGPointMake(13.3, 2))
        iconPath.addCurveToPoint(CGPointMake(15, -0.1), controlPoint1: CGPointMake(14.51, 1.58), controlPoint2: CGPointMake(15, 0.88))
        iconPath.addCurveToPoint(CGPointMake(13.7, -1.87), controlPoint1: CGPointMake(15, -0.88), controlPoint2: CGPointMake(14.51, -1.58))
        iconPath.addCurveToPoint(CGPointMake(11.94, -2), controlPoint1: CGPointMake(13.3, -2), controlPoint2: CGPointMake(12.86, -2))
        iconPath.addLineToPoint(CGPointMake(2.05, -2))
        iconPath.addCurveToPoint(CGPointMake(2.05, -12.18), controlPoint1: CGPointMake(2.05, -7.33), controlPoint2: CGPointMake(2.05, -12.18))
        iconPath.addCurveToPoint(CGPointMake(1.9, -13.97), controlPoint1: CGPointMake(2.05, -13.06), controlPoint2: CGPointMake(2.05, -13.5))
        iconPath.addCurveToPoint(CGPointMake(0.15, -15.2), controlPoint1: CGPointMake(1.63, -14.71), controlPoint2: CGPointMake(0.93, -15.2))
        iconPath.closePath()
        iconPath.moveToPoint(CGPointMake(36, 0))
        iconPath.addCurveToPoint(CGPointMake(-0, 36), controlPoint1: CGPointMake(36, 19.88), controlPoint2: CGPointMake(19.88, 36))
        iconPath.addCurveToPoint(CGPointMake(-36, 0), controlPoint1: CGPointMake(-19.88, 36), controlPoint2: CGPointMake(-36, 19.88))
        iconPath.addCurveToPoint(CGPointMake(-21.75, -28.69), controlPoint1: CGPointMake(-36, -11.71), controlPoint2: CGPointMake(-30.41, -22.12))
        iconPath.addCurveToPoint(CGPointMake(0, -36), controlPoint1: CGPointMake(-15.71, -33.28), controlPoint2: CGPointMake(-8.17, -36))
        iconPath.addCurveToPoint(CGPointMake(36, 0), controlPoint1: CGPointMake(19.88, -36), controlPoint2: CGPointMake(36, -19.88))
        iconPath.closePath()
        fillColor8.setFill()
        iconPath.fill()
    ...
    public class func drawCollectionsCards(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()

        //// icon
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, frame.minX + 0.49956 * frame.width, frame.minY + 0.49530 * frame.height)
        CGContextScaleCTM(context, scale, scale)
        ...
        pathPath.moveToPoint(CGPointMake(10.16, -8.27))
        pathPath.addCurveToPoint(CGPointMake(11.62, -10.41), controlPoint1: CGPointMake(10.82, -9.42), controlPoint2: CGPointMake(11.15, -9.99))
        pathPath.addLineToPoint(CGPointMake(11.7, -10.49))
        pathPath.addCurveToPoint(CGPointMake(13.98, -11.1), controlPoint1: CGPointMake(12.34, -11.02), controlPoint2: CGPointMake(13.17, -11.25))
        pathPath.addCurveToPoint(CGPointMake(16.43, -9.95), controlPoint1: CGPointMake(14.71, -10.94), controlPoint2: CGPointMake(15.28, -10.61))
        pathPath.addLineToPoint(CGPointMake(24.07, -5.54))
        pathPath.addCurveToPoint(CGPointMake(26.21, -4.08), controlPoint1: CGPointMake(25.22, -4.88), controlPoint2: CGPointMake(25.79, -4.55))
        pathPath.addLineToPoint(CGPointMake(26.29, -4))
        pathPath.addCurveToPoint(CGPointMake(26.9, -1.72), controlPoint1: CGPointMake(26.82, -3.36), controlPoint2: CGPointMake(27.05, -2.53))
        pathPath.addCurveToPoint(CGPointMake(25.75, 0.73), controlPoint1: CGPointMake(26.74, -0.99), controlPoint2: CGPointMake(26.41, -0.42))
        pathPath.addLineToPoint(CGPointMake(17.84, 14.44))
        pathPath.addCurveToPoint(CGPointMake(16.38, 16.57), controlPoint1: CGPointMake(17.18, 15.58), controlPoint2: CGPointMake(16.85, 16.15))
        pathPath.addLineToPoint(CGPointMake(16.3, 16.65))
        pathPath.addCurveToPoint(CGPointMake(14.02, 17.26), controlPoint1: CGPointMake(15.66, 17.18), controlPoint2: CGPointMake(14.83, 17.41))
        pathPath.addCurveToPoint(CGPointMake(11.57, 16.11), controlPoint1: CGPointMake(13.29, 17.1), controlPoint2: CGPointMake(12.72, 16.77))
        pathPath.addLineToPoint(CGPointMake(3.93, 11.7))
        pathPath.addCurveToPoint(CGPointMake(2.04, 10.47), controlPoint1: CGPointMake(2.78, 11.04), controlPoint2: CGPointMake(2.46, 10.94))
        color.setStroke()
        ...
        //// path- 2 Drawing
        let path2Path = UIBezierPath()
        path2Path.moveToPoint(CGPointMake(-1.96, 10.47))
        path2Path.addCurveToPoint(CGPointMake(-2.71, 10.92), controlPoint1: CGPointMake(-2.09, 10.62), controlPoint2: CGPointMake(-2.26, 10.61))
        path2Path.addCurveToPoint(CGPointMake(-3.93, 11.7), controlPoint1: CGPointMake(-3.17, 11.23), controlPoint2: CGPointMake(-3.67, 11.55))
        path2Path.addLineToPoint(CGPointMake(-11.57, 16.11))
        path2Path.addCurveToPoint(CGPointMake(-13.9, 17.23), controlPoint1: CGPointMake(-12.72, 16.77), controlPoint2: CGPointMake(-13.29, 17.1))
        path2Path.addLineToPoint(CGPointMake(-14.02, 17.26))
        path2Path.addCurveToPoint(CGPointMake(-16.3, 16.65), controlPoint1: CGPointMake(-14.83, 17.41), controlPoint2: CGPointMake(-15.66, 17.18))
        path2Path.addCurveToPoint(CGPointMake(-17.84, 14.44), controlPoint1: CGPointMake(-16.85, 16.15), controlPoint2: CGPointMake(-17.18, 15.58))
        path2Path.addLineToPoint(CGPointMake(-25.75, 0.73))
        path2Path.addCurveToPoint(CGPointMake(-26.87, -1.6), controlPoint1: CGPointMake(-26.41, -0.42), controlPoint2: CGPointMake(-26.74, -0.99))
        path2Path.addLineToPoint(CGPointMake(-26.9, -1.72))
        path2Path.addCurveToPoint(CGPointMake(-26.29, -4), controlPoint1: CGPointMake(-27.05, -2.53), controlPoint2: CGPointMake(-26.82, -3.36))
        path2Path.addCurveToPoint(CGPointMake(-24.07, -5.54), controlPoint1: CGPointMake(-25.79, -4.55), controlPoint2: CGPointMake(-25.22, -4.88))
        path2Path.addLineToPoint(CGPointMake(-16.43, -9.95))
        path2Path.addCurveToPoint(CGPointMake(-14.1, -11.07), controlPoint1: CGPointMake(-15.28, -10.61), controlPoint2: CGPointMake(-14.71, -10.94))
        path2Path.addLineToPoint(CGPointMake(-13.98, -11.1))
        path2Path.addCurveToPoint(CGPointMake(-11.7, -10.49), controlPoint1: CGPointMake(-13.17, -11.25), controlPoint2: CGPointMake(-12.34, -11.02))
        path2Path.addCurveToPoint(CGPointMake(-10.16, -8.27), controlPoint1: CGPointMake(-11.15, -9.99), controlPoint2: CGPointMake(-10.82, -9.42))
        color.setStroke()
        ...
        //// path- 4 Drawing
        let path4Path = UIBezierPath(roundedRect: CGRectMake(-10.01, -17.31, 20, 28), cornerRadius: 3)
        color.setStroke()
    ...
    public class func drawSettingsDiamond(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        let path1Path = UIBezierPath(roundedRect: CGRectMake(-13.45, -13.45, 26.9, 26.9), cornerRadius: 6.4)
        color.setStroke()
        ...
        //// Oval-17 Drawing
        let oval17Path = UIBezierPath(ovalInRect: CGRectMake(frame.minX + 19.66, frame.minY + 18.66, 10.6, 10.6))
        color.setStroke()
        oval17Path.lineWidth = 3.2
        oval17Path.stroke()
    }

    public class func drawCameraIcon(frame frame: CGRect = CGRectMake(0, 0, 56, 47), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// path-1 Drawing
        let path1Path = UIBezierPath()
        path1Path.moveToPoint(CGPointMake(0, 13.98))
        path1Path.addCurveToPoint(CGPointMake(7.78, 6.2), controlPoint1: CGPointMake(0, 9.68), controlPoint2: CGPointMake(3.48, 6.2))
        path1Path.addLineToPoint(CGPointMake(17.11, 6.2))
        path1Path.addLineToPoint(CGPointMake(18.83, 2.77))
        path1Path.addCurveToPoint(CGPointMake(23.33, 0), controlPoint1: CGPointMake(19.6, 1.24), controlPoint2: CGPointMake(21.62, 0))
        path1Path.addLineToPoint(CGPointMake(32.67, 0))
        path1Path.addCurveToPoint(CGPointMake(37.18, 2.79), controlPoint1: CGPointMake(34.39, 0), controlPoint2: CGPointMake(36.41, 1.25))
        path1Path.addLineToPoint(CGPointMake(38.89, 6.19))
        path1Path.addLineToPoint(CGPointMake(48.22, 6.19))
        path1Path.addCurveToPoint(CGPointMake(56, 13.98), controlPoint1: CGPointMake(52.52, 6.19), controlPoint2: CGPointMake(56, 9.68))
        path1Path.addLineToPoint(CGPointMake(56, 38.67))
        path1Path.addCurveToPoint(CGPointMake(48.21, 46.46), controlPoint1: CGPointMake(56, 42.97), controlPoint2: CGPointMake(52.52, 46.46))
        path1Path.addLineToPoint(CGPointMake(7.79, 46.46))
        path1Path.addCurveToPoint(CGPointMake(0, 38.67), controlPoint1: CGPointMake(3.49, 46.46), controlPoint2: CGPointMake(0, 42.97))
        path1Path.addLineToPoint(CGPointMake(0, 13.98))
        path1Path.closePath()
        path1Path.miterLimit = 4;
        ...
        //// path-3 Drawing
        let path3Path = UIBezierPath(ovalInRect: CGRectMake(17, 14.84, 22, 22))
        color.setStroke()
    ...
    public class func drawDeleteSymbol(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000)) {
        //// Color Declarations
        let fillColor10 = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)

        //// Delete
        //// Oval-170 Drawing
        let oval170Path = UIBezierPath(ovalInRect: CGRectMake(frame.minX + 6, frame.minY + 5.4, 38, 38))
        color.setFill()
        oval170Path.fill()


        //// Rectangle-597 Drawing
        let rectangle597Path = UIBezierPath(roundedRect: CGRectMake(frame.minX + 13.92, frame.minY + 22.02, 22.17, 4.75), cornerRadius: 2.38)
        fillColor10.setFill()
        rectangle597Path.fill()
    }

    public class func drawVerifiedCheck(frame frame: CGRect = CGRectMake(0, 0, 50, 50)) {
        //// Color Declarations
        let strokeColor2 = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)
        let fillColor23 = UIColor(red: 0.547, green: 0.145, blue: 0.999, alpha: 1.000)
        ...
        //// arrow
        //// Oval-113 Drawing
        let oval113Path = UIBezierPath(ovalInRect: CGRectMake(frame.minX + 9, frame.minY + 8, 32, 32))
        fillColor23.setFill()
        oval113Path.fill()
        ...
        path110Path.moveToPoint(CGPointMake(frame.minX + 18, frame.minY + 24.18))
        path110Path.addLineToPoint(CGPointMake(frame.minX + 23.42, frame.minY + 28.46))
        path110Path.addLineToPoint(CGPointMake(frame.minX + 31.57, frame.minY + 19))
        ...
        path110Path.lineWidth = 3
        path110Path.stroke()
    }

    public class func drawEditIcon(frame frame: CGRect = CGRectMake(0, 0, 100, 100), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        let rectangle267Path = UIBezierPath(rect: CGRectMake(-5, -13, 10, 26))
        color.setFill()
        ...
        //// Triangle-1 Drawing
        let triangle1Path = UIBezierPath()
        triangle1Path.moveToPoint(CGPointMake(-14.6, 13.1))
        triangle1Path.addCurveToPoint(CGPointMake(-13.1, 14.6), controlPoint1: CGPointMake(-14.85, 14.18), controlPoint2: CGPointMake(-14.17, 14.85))
        triangle1Path.addLineToPoint(CGPointMake(-5.86, 12.93))
        triangle1Path.addLineToPoint(CGPointMake(-12.93, 5.86))
        triangle1Path.addLineToPoint(CGPointMake(-14.6, 13.1))
        triangle1Path.closePath()
        triangle1Path.miterLimit = 4;
    ...
    public class func drawBackspaceIcon(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.moveToPoint(CGPointMake(9.88, -7.81))
        bezierPath.addLineToPoint(CGPointMake(4.09, -1.98))
        bezierPath.addLineToPoint(CGPointMake(-1.69, -7.81))
        bezierPath.addCurveToPoint(CGPointMake(-3.8, -7.82), controlPoint1: CGPointMake(-2.27, -8.4), controlPoint2: CGPointMake(-3.22, -8.4))
        bezierPath.addCurveToPoint(CGPointMake(-3.79, -5.69), controlPoint1: CGPointMake(-4.38, -7.23), controlPoint2: CGPointMake(-4.38, -6.28))
        bezierPath.addLineToPoint(CGPointMake(1.99, 0.14))
        bezierPath.addLineToPoint(CGPointMake(-3.79, 5.97))
        bezierPath.addCurveToPoint(CGPointMake(-3.8, 8.09), controlPoint1: CGPointMake(-4.38, 6.56), controlPoint2: CGPointMake(-4.38, 7.51))
        bezierPath.addCurveToPoint(CGPointMake(-1.69, 8.09), controlPoint1: CGPointMake(-3.21, 8.68), controlPoint2: CGPointMake(-2.27, 8.68))
        bezierPath.addLineToPoint(CGPointMake(4.09, 2.26))
        bezierPath.addLineToPoint(CGPointMake(9.88, 8.09))
        bezierPath.addCurveToPoint(CGPointMake(11.99, 8.09), controlPoint1: CGPointMake(10.46, 8.68), controlPoint2: CGPointMake(11.41, 8.68))
        bezierPath.addCurveToPoint(CGPointMake(11.98, 5.97), controlPoint1: CGPointMake(12.57, 7.5), controlPoint2: CGPointMake(12.57, 6.56))
        bezierPath.addLineToPoint(CGPointMake(6.2, 0.14))
        bezierPath.addLineToPoint(CGPointMake(11.98, -5.69))
        bezierPath.addCurveToPoint(CGPointMake(11.99, -7.82), controlPoint1: CGPointMake(12.57, -6.28), controlPoint2: CGPointMake(12.57, -7.23))
        bezierPath.addCurveToPoint(CGPointMake(9.88, -7.81), controlPoint1: CGPointMake(11.4, -8.41), controlPoint2: CGPointMake(10.46, -8.4))
        bezierPath.closePath()
        bezierPath.moveToPoint(CGPointMake(24.19, -10.87))
        bezierPath.addLineToPoint(CGPointMake(24.19, 10.87))
        bezierPath.addCurveToPoint(CGPointMake(17.19, 17.86), controlPoint1: CGPointMake(24.19, 14.73), controlPoint2: CGPointMake(21.06, 17.86))
        bezierPath.addLineToPoint(CGPointMake(-4.82, 17.86))
        bezierPath.addCurveToPoint(CGPointMake(-10.09, 15.9), controlPoint1: CGPointMake(-6.47, 17.86), controlPoint2: CGPointMake(-8.82, 16.99))
        bezierPath.addLineToPoint(CGPointMake(-21.61, 6.01))
        bezierPath.addCurveToPoint(CGPointMake(-21.85, -4.67), controlPoint1: CGPointMake(-24.96, 3.14), controlPoint2: CGPointMake(-25.06, -1.66))
        bezierPath.addLineToPoint(CGPointMake(-9.99, -15.81))
        bezierPath.addCurveToPoint(CGPointMake(-4.82, -17.86), controlPoint1: CGPointMake(-8.79, -16.94), controlPoint2: CGPointMake(-6.48, -17.86))
        bezierPath.addLineToPoint(CGPointMake(17.19, -17.86))
        bezierPath.addCurveToPoint(CGPointMake(24.19, -10.87), controlPoint1: CGPointMake(21.05, -17.86), controlPoint2: CGPointMake(24.19, -14.72))
        bezierPath.closePath()
        strokeColor.setFill()
        bezierPath.fill()
    ...
    public class func drawPackBackgroundMask(frame frame: CGRect = CGRectMake(0, 0, 750, 439), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000)) {

        //// path Drawing
        let pathPath = UIBezierPath()
        pathPath.moveToPoint(CGPointMake(frame.minX + 0.00000 * frame.width, frame.minY + -0.00000 * frame.height))
        pathPath.addLineToPoint(CGPointMake(frame.minX + 1.00000 * frame.width, frame.minY + -0.00000 * frame.height))
        pathPath.addLineToPoint(CGPointMake(frame.minX + 1.00000 * frame.width, frame.minY + 0.65976 * frame.height))
        pathPath.addLineToPoint(CGPointMake(frame.minX + 0.00000 * frame.width, frame.minY + 1.00000 * frame.height))
        pathPath.addLineToPoint(CGPointMake(frame.minX + 0.00000 * frame.width, frame.minY + -0.00000 * frame.height))
        pathPath.closePath()
        pathPath.miterLimit = 4;
    ...
    public class func imageOfBackspace(frame2 frame2: CGRect = CGRectMake(-15, -6, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), keySize: CGRect = CGRectMake(0, 0, 35, 35)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame2.size, false, 0)
            StyleKit.drawBackspace(frame2: CGRectMake(0, 0, frame2.size.width, frame2.size.height), color: color, keySize: keySize)
    ...
    public class func imageOfSnapchat(scale scale: CGFloat = 0.5, snapchatSelect: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSizeMake(35, 24), false, 0)
    ...
    public class func imageOfPremium(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawPremium(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color, scale: scale)
    ...
    public class func imageOfCategoryicon(frame frame: CGRect = CGRectMake(0, 0, 35, 35), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawCategoryicon(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color, scale: scale, selected: selected)
    ...
    public class func imageOfGlobe(frame frame: CGRect = CGRectMake(0, 0, 35, 35), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawGlobe(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color, scale: scale, selected: selected)
    ...
    public class func imageOfPacktab(frame frame: CGRect = CGRectMake(19, 11, 50, 50), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawPacktab(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), scale: scale)
    ...
    public class func imageOfEnterkey(frame frame: CGRect = CGRectMake(0, 0, 50, 50), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawEnterkey(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), scale: scale)
    ...
    public class func imageOfClipboard_button(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawClipboard_button(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color, scale: scale, selected: selected)
    ...
    public class func imageOfThumbslider(frame frame: CGRect = CGRectMake(0, 0, 51, 50), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawThumbslider(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), scale: scale)
    ...
    public class func imageOfSlider(frame frame: CGRect = CGRectMake(0, 0, 568, 39), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawSlider(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), scale: scale)
    ...
    public class func imageOfCategoryButton(frame frame: CGRect = CGRectMake(0, 0, 50, 50), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawCategoryButton(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), scale: scale)
    ...
    public class func imageOfGifsButton(frame frame: CGRect = CGRectMake(0, 0, 50, 50), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawGifsButton(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), scale: scale)
    ...
    public class func imageOfQuotesButton(frame frame: CGRect = CGRectMake(0, 0, 50, 50), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawQuotesButton(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), scale: scale)
    ...
    public class func imageOfMenuButton(frame frame: CGRect = CGRectMake(1, 0, 50, 50), selected: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawMenuButton(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), selected: selected)
    ...
    public class func imageOfCategoriesMenuButton(frame frame: CGRect = CGRectMake(0, 0, 50, 50), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawCategoriesMenuButton(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), scale: scale)
    ...
    public class func imageOfQuotesMenuButton(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawQuotesMenuButton(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color, scale: scale, selected: selected)
    ...
    public class func imageOfHashtagicon(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawHashtagicon(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color, scale: scale, selected: selected)
    ...
    public class func imageOfShareButtonCanvas(frame frame: CGRect = CGRectMake(0, 0, 50, 50), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawShareButtonCanvas(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), scale: scale)
    ...
    public class func imageOfShareCanvas(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawShareCanvas(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color, scale: scale, selected: selected)
    ...
    public class func imageOfMainAppMenu(frame frame: CGRect = CGRectMake(0, 0, 35, 35), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawMainAppMenu(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color, scale: scale)
    ...
    public class func imageOfPackMenuButton(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawPackMenuButton(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color)
    ...
    public class func imageOfGifMenuButton(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawGifMenuButton(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color, scale: scale)
    ...
    public class func imageOfDisclosureIndicatorCanvas(frame frame: CGRect = CGRectMake(0, 0, 35, 35), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawDisclosureIndicatorCanvas(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color)
    ...
    public class func imageOfPluscopy(frame frame: CGRect = CGRectMake(0, 0, 72, 72), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawPluscopy(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), scale: scale)
    ...
    public class func imageOfCollectionsCards(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawCollectionsCards(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color, scale: scale)
    ...
    public class func imageOfSettingsDiamond(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawSettingsDiamond(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color)
    ...
    public class func imageOfCameraIcon(frame frame: CGRect = CGRectMake(0, 0, 56, 47), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawCameraIcon(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color, scale: scale)
    ...
    public class func imageOfDeleteSymbol(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawDeleteSymbol(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color)
    ...
    public class func imageOfVerifiedCheck(frame frame: CGRect = CGRectMake(0, 0, 50, 50)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawVerifiedCheck(frame: CGRectMake(0, 0, frame.size.width, frame.size.height))

        let imageOfVerifiedCheck = UIGraphicsGetImageFromCurrentImageContext()
        UIGraphicsEndImageContext()

        return imageOfVerifiedCheck
    }

    public class func imageOfEditIcon(frame frame: CGRect = CGRectMake(0, 0, 100, 100), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawEditIcon(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color, scale: scale)
    ...
    public class func imageOfBackspaceIcon(frame frame: CGRect = CGRectMake(0, 0, 50, 50), color: UIColor = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000), scale: CGFloat = 0.5, selected: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawBackspaceIcon(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), color: color, scale: scale, selected: selected)
