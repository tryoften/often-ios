...
//  Often
//
//  Created by Luc Succes on 1/14/16.
...
public class StyleKit : NSObject {
    ...
    public class func drawToggleCanvas() {
        //// Color Declarations
        ...
        let textForeground2 = UIColor(red: 0.067, green: 0.093, blue: 0.160, alpha: 1.000)
        ...
        let rectangle692Path = UIBezierPath(rect: CGRectMake(0, 0.08, 175, 58))
        ...
        let rectangle692CopyPath = UIBezierPath(rect: CGRectMake(0, 0.08, 88.5, 58))
        fillColor8.setFill()
        ...
        //// Label Drawing
        let labelRect = CGRectMake(31, 11, 26.74, 30)
        let labelStyle = NSParagraphStyle.defaultParagraphStyle().mutableCopy() as! NSMutableParagraphStyle
        labelStyle.alignment = .Left

        let labelFontAttributes = [NSFontAttributeName: UIFont(name: "OpenSans-Light", size: 18)!, NSForegroundColorAttributeName: textForeground, NSParagraphStyleAttributeName: labelStyle]

        "ON".drawInRect(labelRect, withAttributes: labelFontAttributes)


        //// Label 2 Drawing
        let label2Rect = CGRectMake(115, 11, 24.21, 30)
        let label2Style = NSParagraphStyle.defaultParagraphStyle().mutableCopy() as! NSMutableParagraphStyle
        label2Style.alignment = .Left

        let label2FontAttributes = [NSFontAttributeName: UIFont(name: "OpenSans-Bold", size: 18)!, NSForegroundColorAttributeName: textForeground2, NSParagraphStyleAttributeName: label2Style]

        "OF".drawInRect(label2Rect, withAttributes: label2FontAttributes)


        //// Label 3 Drawing
        let label3Rect = CGRectMake(142.75, 11, 9.88, 30)
        let label3Style = NSParagraphStyle.defaultParagraphStyle().mutableCopy() as! NSMutableParagraphStyle
        label3Style.alignment = .Left

        let label3FontAttributes = [NSFontAttributeName: UIFont(name: "OpenSans-Bold", size: 18)!, NSForegroundColorAttributeName: textForeground2, NSParagraphStyleAttributeName: label3Style]

        "F".drawInRect(label3Rect, withAttributes: label3FontAttributes)
    }
