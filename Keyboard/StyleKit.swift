...
//  Often
//
//  Created by Luc Succes on 4/18/16.
...
public class StyleKit : NSObject {
    ...
    public class func drawGlobe(frame frame: CGRect = CGRectMake(0, 0, 35, 35), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// icon
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, frame.minX + 11.41, frame.minY + 10.23)
        CGContextScaleCTM(context, scale, scale)



        //// Oval-75 Drawing
        let oval75Path = UIBezierPath(ovalInRect: CGRectMake(0.33, 0.19, 24.85, 25.09))
        strokeColor3.setStroke()
        ...
        path81Path.moveToPoint(CGPointMake(12.59, 0))
        path81Path.addLineToPoint(CGPointMake(12.59, 26.53))
        ...
        path81CopyPath.moveToPoint(CGPointMake(19.09, 1.5))
        path81CopyPath.addLineToPoint(CGPointMake(19.09, 25.04))
        ...
        path81Copy2Path.moveToPoint(CGPointMake(6.09, 1.5))
        path81Copy2Path.addLineToPoint(CGPointMake(6.09, 25.04))
        ...
        //// Path-82 Drawing
        let path82Path = UIBezierPath()
        path82Path.moveToPoint(CGPointMake(0, 12.73))
        path82Path.addLineToPoint(CGPointMake(25.23, 12.73))
        path82Path.miterLimit = 4;
    ...
    public class func imageOfGlobe(frame frame: CGRect = CGRectMake(0, 0, 35, 35), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawGlobe(frame: CGRectMake(0, 0, frame.size.width, frame.size.height), scale: scale)
