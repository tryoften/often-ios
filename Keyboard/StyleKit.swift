...
//  Often
//
//  Created by Luc Succes on 7/28/16.
...
public class StyleKit : NSObject {
    ...
    public class func drawCamera(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// icon
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, frame.minX + 0.22000 * frame.width, frame.minY + 0.22000 * frame.height)
        CGContextScaleCTM(context, scale, scale)
    ...
    public class func imageOfCamera(frame frame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), scale: CGFloat = 0.5) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawCamera(frame: CGRect(x: 0, y: 0, width: frame.size.width, height: frame.size.height), scale: scale)
