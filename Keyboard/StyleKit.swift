...
//  Often
//
//  Created by Luc Succes on 3/19/16.
...
public class StyleKit : NSObject {
    ...
    public class func drawSmileyEmojiCanvas() {
        //// Color Declarations
        let strokeColor3 = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000)
        let fillColor3 = UIColor(red: 0.095, green: 0.095, blue: 0.095, alpha: 1.000)
        ...
        let oval77CopyPath = UIBezierPath(ovalInRect: CGRectMake(0, 0, 34, 34))
        fillColor10.setFill()
        oval77CopyPath.fill()
        ...
        path594Path.moveToPoint(CGPointMake(7.56, 21.25))
        path594Path.addCurveToPoint(CGPointMake(17, 26.92), controlPoint1: CGPointMake(7.56, 21.25), controlPoint2: CGPointMake(9.92, 26.92))
        path594Path.addCurveToPoint(CGPointMake(26.44, 21.25), controlPoint1: CGPointMake(24.08, 26.92), controlPoint2: CGPointMake(26.44, 21.25))
        ...
        //// Oval-370 Drawing
        let oval370Path = UIBezierPath(ovalInRect: CGRectMake(6.61, 6.61, 6.61, 6.61))
        fillColor3.setFill()
        oval370Path.fill()


        //// Oval-370-Copy Drawing
        let oval370CopyPath = UIBezierPath(ovalInRect: CGRectMake(20.78, 6.61, 6.61, 6.61))
        fillColor3.setFill()
