...
//  Often
//
//  Created by Luc Succes on 8/13/15.
...
public class StyleKit : NSObject {
    ...
    public class func drawButtonclose(#frame: CGRect, color: UIColor, scale: CGFloat) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        var rectangle406Path = UIBezierPath()
        ...
        var rectangle407Path = UIBezierPath()
    ...
    public class func imageOfButtonclose(#frame: CGRect, color: UIColor, scale: CGFloat) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKit.drawButtonclose(frame: frame, color: color, scale: scale)
