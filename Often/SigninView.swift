...
class SigninView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        forgetPasswordButton.setTitle("Forgot?", for: UIControlState())
        forgetPasswordButton.titleLabel!.font = UIFont(name: "Montserrat", size: 11)
        forgetPasswordButton.setTitleColor(CreateAccountViewSignupTwitterButtonColor , for: UIControlState())
