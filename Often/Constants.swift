...
let PresentUserProfileEvent = "PresentUserProfileEvent"
...
let ArtistCollectionViewCellTitleFont = UIFont(name: "OpenSans", size: 15.0)
let ArtistCollectionViewCellSubtitleFont = UIFont(name: "OpenSans", size: 8.0)
