...
class PushNotifcationAlertView: AlertView {
    let declineButton: UIButton
     ...
     override init(frame: CGRect) {
        ...
        declineButton.setTitle("NAH".uppercased(), for: UIControlState())
        declineButton.titleLabel!.font = UIFont(name: "Montserrat", size: 10.5)
        declineButton.setTitleColor(BlackColor , for: UIControlState())
        ...
        actionButton.setTitle("AIGHT".uppercased(), for: UIControlState())
