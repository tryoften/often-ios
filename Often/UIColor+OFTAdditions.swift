//
//  UIColor+OFTAdditions.swift
//
//  Generated by Zeplin on 8/12/16.
...
extension UIColor {
	...
	class func oftBlackTwo90Color() -> UIColor {
		return UIColor(white: 32.0 / 255.0, alpha: 0.9)
	}

	class func oftBlackTwo74Color() -> UIColor {
		return UIColor(white: 32.0 / 255.0, alpha: 0.74)
	}
	...
	class func oftBlackTwo54Color() -> UIColor {
		return UIColor(white: 32.0 / 255.0, alpha: 0.54)
	}
